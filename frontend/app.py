...
# The backend container is named backend on the shared Docker network.
...
Product_MRP = st.number_input('Product MRP', min_value=0.0, value=146.0)
...
if st.button('Predict', type='primary'):
    ...
    if response.status_code == 200:
        ...
        st.error('Error in API request. Check the backend URL.')
